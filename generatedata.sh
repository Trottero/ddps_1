...
do
    ...
    $HIVE_HOME/bin/hive -e "SET mapred.max.split.size=134217728;"
    $HIVE_HOME/bin/hive -e "SET mapred.min.split.size=134217728;"
    $HIVE_HOME/bin/hive -e "SET mapreduce.input.fileinputformat.split.minsize=134217728;"
    $HIVE_HOME/bin/hive -e "SET mapreduce.input.fileinputformat.split.maxsize=134217728;"
